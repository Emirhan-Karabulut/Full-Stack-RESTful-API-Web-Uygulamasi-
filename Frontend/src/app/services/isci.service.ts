...
const API_URL = "http://localhost:8080/api/isciler";
const ISTATISTIK_URL = "http://localhost:8080/api/istatistikler";
const BOLUMLER_URL = "http://localhost:8080/api/bolumler";
